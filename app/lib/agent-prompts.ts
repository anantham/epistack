...
OUTPUT POSTCONDITION FOR FOOD-AND-HEALTH QUESTIONS: before returning the dimensions, check that distinct labels cover outcome, current intake/dose/frequency, preparation/accompaniments, replacement, personal health/life stage, goals/body composition/activity, and practical constraints/access. Add a missing axis before returning; do not treat preparation as implied by intake or practical constraints.
